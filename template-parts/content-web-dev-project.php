<div class="web-dev-card p-1 mb-2 bottom">
              <div class="web-dev-card__col m-auto">
                <div class="web-dev-card__img-wrapper">
                    <img src="<?php the_post_thumbnail_url(); ?>" class="card__img" alt="modra nit image website" />
                    <a href="<?php the_field('url_website'); ?>" target="_blank" class="click-on-website">View Website <img src="/wp-content/themes/boris-galac/assets/icons/view-icon.svg" alt="view website"></a>
                  </div>
                </div>
                <div class="web-dev-card__info d-grid">
                  ...
                  <?php if(get_field('github_code')){ ?>                   
                    <div class="project-card-info__wrapper p-1" aria-label="Github source code">
                      ...
                      <a href="<?php the_field('github_code') ?>" target="_blank" class="figma-btn secondary-btn flex-row-center gap-05">View code for website<img src="/wp-content/themes/boris-galac/assets/icons/github-icon.svg" aria-hidden="true"></a>
                    </div>
                  <?php }
                  ...
                  <div class="project-card-info__wrapper p-1" aria-label="figma design">
                    ...
                    <a href="<?php the_field('figma_design') ?>" target="_blank" class="figma-btn secondary-btn flex-row-center gap-05">View design for website<img src="/wp-content/themes/boris-galac/assets/icons/logos-figma.svg" aria-hidden="true"></a>
                  </div>  
                  <?php } ?>
                </div>
              </div>
